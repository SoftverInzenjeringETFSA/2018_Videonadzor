...
class Help extends Component{
    render(){
        return(
            <div>
                <h1>Help</h1>
                <p>Aplikacija <text style={bordo}>„Aware“</text> kompanije služi za videonadzor objekata. Za uspješno korištenje aplikacije neopodno je znati koristiti se osnovnim funkcionalnostima koje aplikacija pruža.</p>
                <p>Opcija <text style={crveno}>„Live stream“</text> iz horizontalnog menija omogućava gledanje uživo onoga što kamera trenutni snima. 
                <p>Dugme <text style={plavo}>„Start Record“</text> započinje snimanje trenutnog sadržaja koji se prenosi, dok dugme <text style={plavo}>„Stop Record“</text> zaustavlja snimanje, te taj video se spašava u bazu podatka kao i u folder <text style={zeleno}>„Uploads“</text>.</p>
                ...
                <p>Opcija <text style={crveno}>„Videos“</text> iz iz horizontalnog menija omogućava pretraživanje i prikaz snimljenih videa, te se pored svakog pojavljuju dugmad koja omogućavaju sljedeće:</p>
                <p>Dugme  <text style={plavo}>„Search““</text> prikazuje u vidu tabele videe iz baze podataka tj.sve snimljene videe.</p>
                <p>Dugme  <text style={plavo}>„X“</text> briše onaj video pored kojeg smo kliknuli na dugme.</p>
